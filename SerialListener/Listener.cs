...
namespace SerialListener
{
    public class Listener
    {
        ...
        public static bool initReadParm()
        {
        ...
        public static void startNew(TextBox box)
        {
            //   if()    
            text = box;
        ...
        public static void start(TextBox box)
        {
            ...
            if (initReadParm())
            {
                ...
                if (check==0||check == 1 || check == 2||check == 7||check == 8)
                {
                    // Create a new SerialPort object with default settings.
                    _serialPort2 = new SerialPort();
            ...
            else if (check == 5)
            {
                ...
                Thread thread1 = new Thread(new ThreadStart(getStm32ReqAndSend));
                Thread thread2 = new Thread(new ThreadStart(getStm32ResAndShow));
                thread1.Start();
                thread2.Start();
            }else if(check ==7){
                isNewForm1=true;
        ...
        static long stm32Index=0;
        static byte[][]stm32Bytes=new byte[][]{
            new byte[]{0x7E,0x79,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xF9,0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xD8,0x43,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xE5,0x5F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x86,0x58,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xF2,0x7A,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0xC1,0x53,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x93,0x74,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x90,0x2C,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x8C,0xE5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x8C,0xE5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xFF,0x95,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x90,0x2C,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x96,0xBA,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xE5,0x5F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x86,0x58,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0xA0,0x8E,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xE5,0x5F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xD8,0x43,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xF9,0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x90,0x2C,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x9A,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x89,0x9F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x86,0x58,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x93,0x74,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x93,0x74,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x86,0x58,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xDE,0xD1,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xEB,0xEC,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0x86,0x58,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xA3,0xD6,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xA3,0xD6,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xEB,0xEC,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xB0,0xF1,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xF9,0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF4,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xAA,0x63,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xB0,0xF1,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0xC7,0xE1,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xEB,0xEC,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xE5,0x5F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xFF,0x95,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xCB,0x28,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xCB,0x28,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xF2,0x7A,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xCB,0x28,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            ...
            new byte[]{0x7E,0x78,0xF2,0x7A,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xEB,0xEC,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xC4,0x9B,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xDE,0xD1,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xDE,0xD1,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xD8,0x43,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xC4,0x9B,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            ...
            new byte[]{0x7E,0x78,0xE5,0x5F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xF2,0x7A,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xF9,0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xBE,0x0C,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xAA,0x63,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x90,0x2C,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x90,0x2C,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xDE,0xD1,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xC4,0x9B,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x89,0x9F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0xEB,0xEC,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x90,0x2C,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xDE,0xD1,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            ...
            new byte[]{0x7E,0x78,0xA3,0xD6,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xDE,0xD1,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xF9,0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xA3,0xD6,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x96,0xBA,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xFF,0x95,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xA3,0xD6,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xF9,0x08,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            ...
            new byte[]{0x7E,0x78,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xEB,0xEC,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x79,0xFF,0x95,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xCB,0x28,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0xEB,0xEC,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x41,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF6,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x75,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF3,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xCB,0x28,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x89,0x9F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xDE,0xD1,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            ...
            new byte[]{0x7E,0x77,0xC4,0x9B,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xAA,0x63,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x90,0x2C,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xEB,0xEC,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            ...
            new byte[]{0x7E,0x77,0xC4,0x9B,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xC1,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x73,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x75,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x41,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF6,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x75,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x75,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x75,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF6,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x75,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xAA,0x63,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF6,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0x89,0x9F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x78,0xA3,0xD6,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xC4,0x9B,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            ...
            new byte[]{0x7E,0x76,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x90,0x2C,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xAA,0x63,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xC4,0x9B,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0xEB,0xEC,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            ...
            new byte[]{0x7E,0xF4,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xC1,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF6,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF5,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x41,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF3,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF5,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF6,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x73,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x73,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x77,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF6,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x74,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x75,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x41,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF5,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x74,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            ...
            new byte[]{0x7E,0x75,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0x9D,0x48,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0x76,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            ...
            new byte[]{0x7E,0xF6,0xD1,0xB5,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF6,0x83,0x12,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF6,0xEB,0xEC,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF7,0x90,0x2C,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}, 
            new byte[]{0x7E,0xF7,0xB7,0x7F,0x00,0x00,0x00,0x00,0x00,0x00,0x0D}
        };
        public static void getStm32ReqAndSend()
        {
            while (_continue1)
            {
                if (MasterIsOn)
                ...
                try
                {
                    ...
                    if (rxbytearray.Length >= 2&&rxbytearray[0]==0x7D&&rxbytearray[1]==0x00)
                    {
                        if(stm32Index<stm32Bytes.Length)
                            sendRes(stm32Bytes[stm32Index++]);
                        text.Invoke((MethodInvoker)delegate
                        {
                            // Running on the UI thread
                            /*text.Text += "下位机回复: " + byteToString(rxbytearray);
                            file.Write("下位机回复: " + byteToString(rxbytearray));*/
                        });
                    }
        ...
        public static void getStm32ResAndShow(){
                    ...
                    if (rxbytearray.Length != 0)
                    {
                        ...
                        text.Invoke((MethodInvoker)delegate
                        {
                            ...
                            if (text.Text.Length > 10240)
                                text.Text = "";
                            text.Text += "上位机指令:" + Encoding.ASCII.GetString(rxbytearray)+"\r\n";
